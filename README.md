...
A clone of the card game Coup written in Node.js. For an explanation of how to play, see `web/rules.html`.
...
Then open `http://localhost:8080` in one or more browser windows.
